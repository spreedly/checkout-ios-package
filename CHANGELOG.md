...
### Changes
- Add dSYM file upload to Datadog in release workflow
...
- **Version History**: Semantic versioning maintained (0.0.56 - Patch Version)
...
.package(url: "https://github.com/spreedly/checkout-ios-package.git", from: "0.0.56")
```
