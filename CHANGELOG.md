...
### Changes
- Refactor Package.swift parsing and dependency mapping in release workflow
...
- **Version History**: Semantic versioning maintained (0.0.48 - Patch Version)
...
.package(url: "https://github.com/spreedly/checkout-ios-package.git", from: "0.0.48")
```
