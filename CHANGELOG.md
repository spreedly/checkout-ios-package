...
### Changes
- HC-1305 Audit release docs for version parity and package repo flow accuracy (#227)
- HC-1302 iOS documentation accuracy audit and related fixes (#226)
- HC-1301 add version source of truth, gpg signing, and release parity (#224)
- HC-1285 Add go-live documentation, fix Braintree and offsite flows, sync dependencies (#223)
- HC-1278 add Gitleaks secret scanning CI, pre-commit hook, and docs (#220)
...
- **Version History**: Semantic versioning maintained (1.3.0 - Minor Version)
