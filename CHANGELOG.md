...
### Changes
- Update integration guide and add user-focused README for Spreedly iOS SDK
...
- Updated dependabot config (#85)
- Add dependency security scanning with Dependabot (#84)
...
- **Version History**: Semantic versioning maintained (0.0.46 - Patch Version)
...
.package(url: "https://github.com/spreedly/checkout-ios-package.git", from: "0.0.46")
```
