...
SWIFT_ENUM_FWD_DECL(NSInteger, DropInNameDisplayMode)
@class NSString;
...
SWIFT_ENUM_FWD_DECL(NSInteger, YearFormat)
SWIFT_ENUM_FWD_DECL(NSInteger, CardNumberFormat)
@class FormField;
...
SWIFT_ENUM_FWD_DECL(NSInteger, FormFieldType)
...
@class UIView;
SWIFT_ENUM_FWD_DECL(NSInteger, SpreedlySubmitLabel)
...
@property (nonatomic, copy) NSString * _Nullable requiredMessage;
@property (nonatomic) enum YearFormat yearFormat;
...
- (nonnull instancetype)initWithField:(enum FormFieldType)field title:(NSString * _Nullable)title isRequired:(BOOL)isRequired placeholder:(NSString * _Nullable)placeholder keyboardType:(UIKeyboardType)keyboardType textContentType:(UITextContentType _Nullable)textContentType lightThemeConfig:(SPLThemeConfig * _Nullable)lightThemeConfig darkThemeConfig:(SPLThemeConfig * _Nullable)darkThemeConfig onValidationChange:(void (^ _Nullable)(BOOL))onValidationChange onSubmit:(void (^ _Nullable)(void))onSubmit submitLabel:(enum SpreedlySubmitLabel)submitLabel onFocus:(void (^ _Nullable)(void))onFocus;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
