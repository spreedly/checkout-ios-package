...
#ifndef SPREEDLYBRAINTREE_SWIFT_H
#define SPREEDLYBRAINTREE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpreedlyBraintree",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17SpreedlyBraintree23BraintreeURLHandlerObjC")
...
SWIFT_CLASS("_TtC17SpreedlyBraintree25SpreedlyBraintreeCheckout")
@interface SpreedlyBraintreeCheckout : NSObject
/// <code>true</code> when Braintree checkout can be used (always true in this module).
