...
/// Eligibility flags for native PPCP funding sources. Local UI pre-filter matching Android
/// <code>PayPalEligibilityChecker</code> (PayPal iOS SDK has no native eligibility API).
...
+ (void)paypalVaultStartedWithUsageType:(NSString * _Nonnull)usageType presentation:(NSString * _Nonnull)presentation rdaAvailable:(BOOL)rdaAvailable;
