...
/// Whether <code>preservePaymentStateOnNextShow()</code> is pending (skip card-brand reset on sheet dismiss).
- (BOOL)isDropInPreserveStateScheduled SWIFT_WARN_UNUSED_RESULT;
@end
