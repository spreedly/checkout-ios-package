...
[![GitHub Package](https://img.shields.io/badge/GitHub%20Package-1.4.0-rc.5-blue)](https://github.com/spreedly/checkout-ios-package/releases)
...
```swift
dependencies: [
    .package(url: "https://github.com/spreedly/checkout-ios-package", from: "1.4.0-rc.5")
]
```
...
- **SPM:** `from: "1.4.0-rc.5"` (accepts compatible minor/patch updates)
