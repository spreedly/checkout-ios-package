...
[![GitHub Package](https://img.shields.io/badge/GitHub%20Package-1.6.0-rc.1-blue)](https://github.com/spreedly/checkout-ios-package/releases)
...
```swift
dependencies: [
    .package(url: "https://github.com/spreedly/checkout-ios-package", from: "1.6.0-rc.1")
]
```
...
- **SPM:** `from: "1.6.0-rc.1"` (accepts compatible minor/patch updates)
