...
[![GitHub Package](https://img.shields.io/badge/GitHub%20Package-1.5.0-blue)](https://github.com/spreedly/checkout-ios-package/releases)
...
```swift
dependencies: [
    .package(url: "https://github.com/spreedly/checkout-ios-package", from: "1.5.0")
]
```
...
- **SPM:** `from: "1.5.0"` (accepts compatible minor/patch updates)
