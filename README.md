...
[![GitHub Package](https://img.shields.io/badge/GitHub%20Package-1.4.0-blue)](https://github.com/spreedly/checkout-ios-package/releases)
...
- **SPM:** `from: "1.4.0"` (accepts compatible minor/patch updates)
