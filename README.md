...
[![GitHub Package](https://img.shields.io/badge/GitHub%20Package-1.3.8-rc.2-blue)](https://github.com/spreedly/checkout-ios-package/releases)
...
```swift
dependencies: [
    .package(url: "https://github.com/spreedly/checkout-ios-package", from: "1.3.8-rc.2")
]
```
...
- **SPM:** `from: "1.3.8-rc.2"` (accepts compatible minor/patch updates)
