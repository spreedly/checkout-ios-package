...
- [3DS_GATEWAY_SPECIFIC_FLOW.md](https://github.com/spreedly/checkout-ios-sdk/blob/main/SpreedlyDocs/development/3DS_GATEWAY_SPECIFIC_FLOW.md) – Detailed flow diagrams for gateway-specific 3DS including device fingerprint, trigger/finalize, challenge lifecycle, and decision flows
